                                            ...
                                            @foreach($roles as $role)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade text-left" id="editRoleModal{{ $role->id }}"
                                                            tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="editRoleModalLabel{{ $role->id }}">Editar
                                                                            Rol</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form id="editRoleForm{{ $role->id }}" method="POST"
                                                                            ...
                                                                            <div class="row mb-3">
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <input type="text" class="form-control uper"
                                                                                        id="name" name="name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" form="addRoleForm" class="btn btn-primary"
                                            onclick="return validatePassword()">Guardar</button>
                                    </div>
                            </form>
                        </div>
                    </div>
