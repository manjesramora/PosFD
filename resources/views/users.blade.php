                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        <div class="input-group mb-3 col-3">
                            <input type="text" class="form-control uper" placeholder="Buscar usuario" id="searchUser" onkeyup="filterUsers()">
                        </div>
                        <div class="input-group mb-3 col-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive small-font">
                                    <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th class="col-1 text-center align-middle">USUARIOS</th>
                                                <th class="col-1 text-center align-middle">NOMBRE EMPLEADO</th>
                                                <th class="col-1 text-center align-middle">ROL</th>
                                                <th class="col-1 text-center align-middle">ESTADO</th>
                                                <th class="col-1 text-center align-middle">CENTRO DE COSTO</th>
